...
class TestBuildRecoupmentExtract:
    def test_each_source_line_is_negated_with_dash_r_suffix(self):
        ...
        assert first.invoice_number == "10_001-R"
        ...
        assert second.invoice_number == "11_001-R"
