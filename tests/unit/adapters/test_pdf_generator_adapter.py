...
def test_generate_pdf_returns_bytes():
    ...
    adapter = PdfGeneratorAdapter(provider_details_port=mock_provider_port)
...
def test_populate_certificate_context_returns_ApplicationCertificate():
    ...
    result = adapter.populate_certificate_context(application, proceeding)
...
def test_populate_certificate_context_uses_correspondence_address_when_available():
    ...
    result = adapter.populate_certificate_context(application, application_proceeding)
...
def test_populate_certificate_context_raises_exception_on_firm_name_lookup_failure():
    ...
    with pytest.raises(ProviderDetailsRetrievalError):
        adapter.populate_certificate_context(application, application_proceeding)
