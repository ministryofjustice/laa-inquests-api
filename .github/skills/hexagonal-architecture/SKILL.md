...
description: Core rules for developing code with hexagonal architecture. Use this whenever writing, reviewing, or refactoring any code that follows hexagonal architecture or making any recommendations about hexagonal architecture. References the other hex-arch skills for specifics.
---

# Hexagonal Architecture

Apply hexagonal architecture principles whenever writing new code or modifying existing code in this project.
