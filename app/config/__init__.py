...
class Config:
    ...
    GOV_NOTIFY_FINAL_BILL_CLAIM_REJECT_TEMPLATE_ID = os.environ.get(
        "GOV_NOTIFY_FINAL_BILL_CLAIM_REJECT_TEMPLATE_ID", ""
    )
    GOV_NOTIFY_FINAL_BILL_CLAIM_GRANT_TEMPLATE_ID = os.environ.get(
        "GOV_NOTIFY_FINAL_BILL_CLAIM_GRANT_TEMPLATE_ID", ""
    )
    GOV_NOTIFY_POA_CLAIM_AUTO_APPROVE_TEMPLATE_ID = os.environ.get(
        "GOV_NOTIFY_POA_CLAIM_AUTO_APPROVE_TEMPLATE_ID", ""
    )
